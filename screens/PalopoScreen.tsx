    ...
    return (
        ...
        >
            ...
            <div className="p-3 flex flex-col flex-grow">
                ...
                {/* FIX: Changed course name to Palopo */}
                <p className="text-xs text-gray-500 mb-3 flex-grow">Budaya Palopo</p>
...
// FIX: Renamed component to PalopoScreen and added default export.
export default function PalopoScreen({ 
  user, 
  onBack,
  materials,
  setAllMaterials,
  ...
  return (
    <div className="space-y-4">
      {/* FIX: Changed header subtitle to Palopo */}
      <Header subtitle="Kota Palopo" user={user} notifications={[]} setNotifications={() => {}}>
