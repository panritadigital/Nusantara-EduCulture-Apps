...
interface TanaTorajaScreenProps {
    ...
    return (
        ...
        >
            ...
            <div className="p-3 flex flex-col flex-grow">
                ...
                <p className="text-xs text-gray-500 mb-3 flex-grow">Budaya Tana Toraja</p>
...
export default function TanaTorajaScreen({ 
  user, 
  onBack,
  materials,
  setAllMaterials,
  ...
  return (
    <div className="space-y-4">
      <Header subtitle="Kab. Tana Toraja" user={user} notifications={[]} setNotifications={() => {}}>
