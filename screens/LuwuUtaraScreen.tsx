...
interface LuwuUtaraScreenProps {
    ...
    return (
        ...
        >
            ...
            <div className="p-3 flex flex-col flex-grow">
                ...
                <p className="text-xs text-gray-500 mb-3 flex-grow">Budaya Luwu Utara</p>
...
export default function LuwuUtaraScreen({ 
  user, 
  onBack,
  materials,
  setAllMaterials,
  ...
  return (
    <div className="space-y-4">
      <Header subtitle="Kab. Luwu Utara" user={user} notifications={[]} setNotifications={() => {}}>
